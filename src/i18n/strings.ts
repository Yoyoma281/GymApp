...
export const strings: Record<string, UIStrings> = {
  en: {
    ...
    thisTechnique: 'This exact technique',
    muscles: 'Muscles',
  ...
  ar: {
    ...
    thisTechnique: 'هذه التقنية بالضبط',
    muscles: 'العضلات',
    difficulty: 'المستوى',
  ...
  de: {
    ...
    thisTechnique: 'Genau diese Technik',
    muscles: 'Muskeln',
    difficulty: 'Niveau',
  ...
  es: {
    ...
    thisTechnique: 'Esta técnica exacta',
    muscles: 'Músculos',
    difficulty: 'Nivel',
  ...
  fa: {
    ...
    thisTechnique: 'دقیقاً همین تکنیک',
    muscles: 'عضلات',
    difficulty: 'سطح',
  ...
  fr: {
    ...
    thisTechnique: 'Cette technique exacte',
    muscles: 'Muscles',
    difficulty: 'Niveau',
  ...
  it: {
    ...
    thisTechnique: 'Questa tecnica esatta',
    muscles: 'Muscoli',
    difficulty: 'Livello',
  ...
  pl: {
    ...
    thisTechnique: 'Dokładnie ta technika',
    muscles: 'Mięśnie',
    difficulty: 'Poziom',
  ...
  pt: {
    ...
    thisTechnique: 'Esta técnica exata',
    muscles: 'Músculos',
    difficulty: 'Nível',
  ...
  ru: {
    ...
    thisTechnique: 'Именно этот приём',
    muscles: 'Мышцы',
    difficulty: 'Уровень',
  ...
  tr: {
    ...
    thisTechnique: 'Tam olarak bu teknik',
    muscles: 'Kaslar',
    difficulty: 'Seviye',
